 ...
 * @see sh.roadmap.tavi.weatherapi.tools.SimpleReader SimpleReader to read from the hard drive
 * @see sh.roadmap.tavi.weatherapi.tools.ResourcesReader ResourcesReader to read from "resources" 
 */
